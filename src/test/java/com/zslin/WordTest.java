...
//    }
    ...
    public void testExportWord2() throws Exception {
        ...
        String expFile = "/Users/imac_dhht/Desktop/result.doc";
        Map<String, String> datas = new HashMap<String, String>();
        datas.put("title", "标题部份");
        datas.put("content1", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content2", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content3", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content4", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content5", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content6", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content7", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content8", "这里是内容，测试使用POI导出到Word的内容！");
        datas.put("content8", "这里是内容，测试使用POI导出到Word的内容！");
        Date date = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String date1 = sdf.format(date);
        datas.put("content10", date1);
        datas.put("author", "cuiyang");
        datas.put("url", "http://www.zslin.com");
